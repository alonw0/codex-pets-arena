...
export type CodexPetAnimation = keyof typeof CODEX_PET_ATLAS.animations;

export const REQUIRED_ANIMATIONS = Object.keys(CODEX_PET_ATLAS.animations) as CodexPetAnimation[];
